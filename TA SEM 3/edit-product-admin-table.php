...
if (isset($_SESSION['username']) && isset($_SESSION['id'])) { ?>
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                <form action="edit-product-admin-table.php?id=<?= $id ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-3">
                                ...
                                <p class="mt-2 ">
                                    ...
                                    <a href="product-admin-table.php" class="btn btn-outline-warning" name="back" type="submit" style="width:49%">Back</a>
                                </p>
                            </div>
                        </div>
                ...
                if (isset($_POST['submit'])) {
                    ...
                    if ($error === 0) {
                        if ($img_size > 1250000) {
                            ...
                            if (in_array($img_ex_lc, $allowed_exs)) {
                                ...
                                $result = mysqli_query($koneksi, $query);
                                echo "<meta http-equiv='refresh' content='1; url=http://localhost/wsi/WSI/TA%20SEM%203/edit-product-admin-table.php?id={$id}'>";
                            } else {
                                $txt = "Format Tidak Didukung";
                                header("Location: edit-product-admin-table.php?error=$txt");
                            }
                        }
                    } else {
                    ...
                    // header("Location: product-admin-table");
                }
                ?>
